  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-teal-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="flex items-center">
              ...
              <div>
                <h3 className="text-red-800 font-medium">
                  High Emergency Wait Times
                </h3>
                <p className="text-red-700 text-sm mt-1">
                  Current avg wait time in KWC Region is{" "}
                  {formatTime(stats.overallAverageWaitNum)}. Consider visiting
                  nearby urgent care centers or walk-in clinics for
        ...
        <WaitTimeGraph
          onStatsUpdate={({
            emergencyWaitTime,
            patientCount,
            overallAverageWaitNum,
            overallAverageWaitText,
            overallAveragePatients,
          }) =>
            setStats({
              emergencyWaitTime,
              patientCount,
      ...
      <Chatbot
        ...
        setUserLocationForResult={setUserLocation}
